...
# Initialise all the variables, set default values for some
    def __init__(self, iface):
        ...
        self.metadata = ""      # Contains metadata for the CESM library used
        self.cesomlVer = ""     # Current version for CESMapper
        self.libVersion = ""    # Contains the version number for the CESM library
        self.libName = ""
        self.numLevels = 1
...
# *********  run method that performs all the real work ***********************
    ...
    def run(self):
        ...
        # Something in place in case tool is restarted without being reloaded; 
...
# ***************** Get save file name ****************
    ...
    def browse_outfiles(self):
        ...
        self.shapeMapFile = QFileDialog.getSaveFileName(None, str("Output Shapefile"),self.writeDlg.ui.output.displayText(), "*.shp")
...
# ***************** Get input file name ****************
    ...
    def browse_infiles(self):
        ...
        self.shapeMapFile = QFileDialog.getOpenFileName(None, str("Input Shapefile"),self.readDlg.ui.input.displayText(), "*.shp")
